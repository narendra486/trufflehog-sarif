...
Convert TruffleHog `--json` output into SARIF 2.1.0 so the findings can be pushed into GitHub Code Scanning or any SARIF-compatible platform.
...
- Accepts stdin/stdout for piping or file paths for batch jobs.
